...
const TeacherRegister = ({ setShowComponent }: RegistrarProps) => {
  return (
    <div className="w-full h-full flex flex-col items-center z-10 fixed left-0 right-0 top-0 bottom-0 backdrop-blur-sm bg-[#101c161d]">
      <div className="m-auto flex flex-col items-center w-[480px] h-auto shadow-md bg-white rounded-[15px] mt-12 gap-4 p-6">
        ...
        <div className="text-center w-full">
          <h1 className="text-[22px] font-bold text-[#322F37]">Register New Teacher</h1>
          <p className="text-[14px] text-[#605D66] mt-1">Fill in the details below to register a new Teacher.</p>
        </div>
        ...
        <div className="flex flex-col gap-4 w-full text-[#49454F]">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col w-1/2">
              <label className="text-[14px]">STAFF ID No:</label>
              <input
                type="text"
                placeholder="ST12345"
                className="h-[40px] border border-[#9eabbf] rounded-[8px] px-3 mt-1 outline-none"
          ...
          {/* Guardian Contact */}
          <div className="flex flex-col">
            <label className="text-[14px]">Teacher Contact</label>
            <input
              type="text"
           ...
           {/* Teacher ID */}
          <div className="flex flex-col">
            <label className="text-[14px]">Upload Your Staff ID</label>
            <input
              type="file"
