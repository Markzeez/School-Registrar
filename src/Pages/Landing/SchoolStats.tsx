...
const SchoolStats = () => {
  return (
    <div className="relative bg-white text-[#487ad6] py-10 px-4 md:px-12">
      {/* Background */}
      ...
      <div className="relative z-10 flex flex-col gap-6 lg:gap-10">
        {/* Heading */}
        <div className="text-left lg:max-w-[70%]">
        ...
        {/* Sponsor Carousel */}
        <div className="bg-[#151515] p-6 rounded-lg shadow-md border border-[#3d3e3e]">
          <h2 className="text-xl lg:text-2xl font-semibold text-center mb-4">Trusted by Leading Brands</h2>
          <Swiper
            spaceBetween={30}
            slidesPerView={2}
            breakpoints={{
        ...
        {/* Stats */}
        <div className="flex flex-wrap justify-evenly items-center gap-6 mt-8">
